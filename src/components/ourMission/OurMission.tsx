    ...
    <section className={classes.root}>
      <Grid container className={classes.content1}>
        <Grid item sm={12} md={6}>
          ...
          traditional wear of different states with superior quality and value to the consumer.
          We will accomplish this by being committed to offering great service and real value to our consumers.
          We revolutionize fashion among all age group women at addictive prices
